$(document).ready(function() {
    ...
    function showQuote() {
        ...
        var bob_marley = new info(
            ...
            " Bob Marley",
            "https://images.gr-assets.com/authors/1207771636p8/25241.jpg"
        );
        ...
        // Displays data
        $("#img").html("<div class='container'><img src='" + image + "'class='img img-responsive'></div>");
    ...
    $("#getQuote").on("click", function() {
        ...
        buttons = "<div class='row'><div class='col-md-6'>" +
            "<span id='img'></span>" +
            "<div class='row'>" +
            "<div class='col-md-6'>" +
            "<button type='button' id='twitter' class='btn btn-md'>Tweet it! <i class='fa fa-twitter'></i></button>" +
            "</div>" +
            "div class='col-md-6'" +
            "<button id='getQuote' class='btn btn-md fa fa-quote-left'> Show Quote</button>" +
            "</div>" +
            "</div>" +
            "<div class='col-md-6'>" +
            "<span id='quote'></span>" +
            "<span><p id='name'></p></span>" +
            "</div>" +
            "</div>";
        $("#body").html(buttons);
        showQuote();
